...
namespace Backender.CodeEditor.CSharp
{
    public static class CodeBuilder
    {
        ...
        public static Property AddProperty(this Class _class, string propertyDataType, string propertyName,AccessModifier accessModifier = AccessModifier.Public, bool isVirtual = false)
        {
